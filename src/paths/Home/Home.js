...
function Home() {
  ...
  const fetchPaths = () => {
    axios.get("http://localhost:8080/paths").then((response) => {
              ...
              {paths.length ? (
                  paths.map((path) => (
                      ...
                      <div   key={`path-item-${path._id}`}
                             ...
                             data-aos-once="true" style={{margin:'20px'}} className="col-lg-5 col-md-5 col-sm-12  mt-5 mt-md-3 mt-sm-3 aos-init aos-animate">
