...
function BookmarkPage() {
    ...
    const fetchCourses = () => {
        axios.get("http://localhost:8080/courses/bookmarks").then((response) => {
    ...
    const fetchPaths = () => {
        axios.get("http://localhost:8080/paths/bookmarks").then((response) => {
        ...
        >
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="section-title text-center">
                            <span className="subtitle">Here are the bookmark  paths </span>
                            <h2 className="title">Bookmark Paths</h2>
                        </div>
                    </div>
                </div>
                <br/>            <br/>
                ...
                <div className="row">
                    <div className="col-lg-12">
                        <div className="section-title text-center">
                            <span className="subtitle">Here are the bookmark courses </span>
                            <h2 className="title">Bookmark Courses</h2>
                        </div>
                    </div>
                </div>
